...
library(readxl)
base_manual_PMQQS = read_excel("D:/UFMG/OneDrive/Doutorado - UFMG/Tese/Resultados/Eixo I/Análise alternativa sem outliers e correção do LDA/Análise - inglês/Bases sazonais/Resultados/base_pmqqs_chuvoso_LDA_unico_sem_outliers_ingles.xlsx")
...
#Eliminando parâmetros com entropia nula
...
#Função para retornar o número de casa decimais de um número
...
#Função para atribuir o número de casas decimais de cada variável a cada dado dado observado
...
#Funçao para gerar a entropia marginal
library(entropy)
...
write.xlsx(x = entropia_marginal_var_pmqqs_df, file = "D:/UFMG/OneDrive/Área de Trabalho/Entropia_marginal_PMQQS_periodo_chuvoso_LDA_unico_sem_outliers_ingles.xlsx")
write.xlsx(x = base_id_sem_entropia_nula, file = "D:/UFMG/OneDrive/Área de Trabalho/Base_PMQQS_sem_var_entropia_nula_periodo_chuvoso_LDA_unico_sem_outliers_ingles.xlsx")
write.xlsx(x = base_entropia_nula_PMQQS, file = "D:/UFMG/OneDrive/Área de Trabalho/Base_PMQQS_Entropia_nula_periodo_chuvoso_LDA_unico_sem_outliers_ingles.xlsx")
